...
If this is important to you, please consider supporting Rollup to make a native build for your platform and architecture available.`
    ...
    var requireWithFriendlyError = (id) => {
      try {
        ...
        if (platform2 === "win32" && error2 instanceof Error && error2.code === "ERR_DLOPEN_FAILED" && error2.message.includes("The specified module could not be found")) {
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-XMCHXZFM.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-MH273HKG.js.map
