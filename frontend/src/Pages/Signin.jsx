...
//         e.preventDefault()
//         try {
//             const {data} = await axios.post("/api/v1/user/signin", {email: email, password: password});
...
//                     <Form.Control required onChange={(e) => setPassword(e.target.value)} placeholder="Enter Password"></Form.Control>
//                 </Form.Group>
//                 <div className="mb-3">
