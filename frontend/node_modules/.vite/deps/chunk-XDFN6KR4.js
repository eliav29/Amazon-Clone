...
} from "./chunk-KQN56KWQ.js";
import {
  TabContext_default
} from "./chunk-2CBFSXRF.js";
import {
...
import {
  ...
  makeEventKey
} from "./chunk-X7FKCQJ2.js";
import {
  Image_default,
  propTypes
} from "./chunk-J6GYTQ2V.js";
import {
  Anchor_default,
  useCallbackRef
} from "./chunk-R67PIMMB.js";
import {
  CloseButton_default,
  ENTERING,
  EXITING,
...
var FigureImage = React18.forwardRef(({
  className,
  fluid = true,
  ...props
  ...
  ...props,
  fluid,
  className: (0, import_classnames15.default)(className, "figure-img")
}));
...
var FigureCaption = React19.forwardRef(({
  className,
  bsPrefix,
...
var ModalBody = React21.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalDialog = React22.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
  ...
  return (0, import_jsx_runtime23.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames19.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
...
var ModalFooter = React23.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalHeader = React24.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React25.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime27.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal = React26.forwardRef(({
  ...
  const renderBackdrop = (0, import_react9.useCallback)((backdropProps) => (0, import_jsx_runtime27.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime27.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime27.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime27.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime27.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
var NavItem = React27.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav = React28.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React29.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
...
var PopoverHeader = React30.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React31.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React33.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Tooltip = React34.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
  ...
  return (0, import_jsx_runtime35.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames29.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
var Overlay2 = React35.forwardRef(({
  children: overlay,
  ...
  return (0, import_jsx_runtime36.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React35.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
        hasDoneInitialMeasure,
        className: (0, import_classnames30.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React36.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime39.jsxs)(import_jsx_runtime38.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react15.cloneElement)(children, triggerProps), (0, import_jsx_runtime37.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React37.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime40.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames31.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime41.jsxs)(Component2, {
      className: (0, import_classnames31.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime40.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React37.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime41.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime42.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames32.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames33.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React39.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime43.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React40.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime45.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames34.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime45.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var Ratio = React42.forwardRef(({
  ...
  return (0, import_jsx_runtime46.jsx)("div", {
    ...
    className: (0, import_classnames35.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React42.Children.only(children)
  });
});
...
var TabContent = React48.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React49.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime54.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime54.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime54.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        children: (0, import_jsx_runtime54.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames38.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime56.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime56.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime57.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime56.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
      children: map(children, renderTab)
    }), (0, import_jsx_runtime56.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime56.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React52.forwardRef((props, ref) => (0, import_jsx_runtime58.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React54.forwardRef(({
  ...
  return (0, import_jsx_runtime60.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames40.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime59.jsx)(CloseButton_default, {
...
var ToastBody = React55.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React56.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime62.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames42.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
...
var ToastContainer = React57.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime63.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames43.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop2 = () => void 0;
var ToggleButton = React58.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime66.jsxs)(import_jsx_runtime65.Fragment, {
    children: [(0, import_jsx_runtime64.jsx)("input", {
      ...
      ...props,
      ref,
      className: (0, import_classnames44.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React59.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
...
//# sourceMappingURL=chunk-XDFN6KR4.js.map
