      ...
      const s3 = /* @__PURE__ */ function(e4, n3, o4) {
        ...
        return { id: e4, props: g2, observe: (e5) => (h2.add(e5), () => h2.delete(e5)), toggle: (e5, t2) => {
          ...
          const $2 = { ...g2, style: g2.toastStyle, key: s4++, ...Object.fromEntries(Object.entries(l3).filter((e5) => {
            let [t2, n5] = e5;
            return null != n5;
          })), toastId: f3, updateId: h3, data: I2, closeToast: L2, isIn: false, className: p(l3.className || g2.toastClassName), bodyClassName: p(l3.bodyClassName || g2.bodyClassName), progressClassName: p(l3.progressClassName || g2.progressClassName), autoClose: !l3.isLoading && (k2 = l3.autoClose, P2 = g2.autoClose, false === k2 || c(k2) && k2 > 0 ? k2 : P2), deleteToast() {
          ...
          let w2 = n4;
          (0, import_react.isValidElement)(n4) && !d(n4.type) ? w2 = (0, import_react.cloneElement)(n4, { closeToast: L2, toastProps: $2, data: I2 }) : u(n4) && (w2 = n4({ closeToast: L2, toastProps: $2, data: I2 }));
          const M2 = { content: w2, props: $2, staleId: _2 };
...
var P = () => "" + k++;
function w(e2) {
  return e2 && (d(e2.toastId) || c(e2.toastId)) ? e2.toastId : P();
}
function M(e2, t2) {
  return _(e2, t2), t2.toastId;
}
function x(e2, t2) {
  return { ...t2, type: t2 && t2.type || e2, toastId: w(t2) };
}
function A(e2) {
...
B.loading = (e2, t2) => M(e2, x("default", { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...t2 })), B.promise = function(e2, t2, n2) {
  ...
  if (n2) {
    const { props: o2, content: s2 } = n2, a2 = { delay: 100, ...o2, ...t2, toastId: t2.toastId || e2, updateId: P() };
...
var D = { info: function(t2) {
  ...
  return import_react.default.createElement(O, { ...t2 }, import_react.default.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}, error: function(t2) {
...
var z = (n2) => {
  const { isRunning: o2, preventExitTransition: s2, toastRef: r3, eventHandlers: i2, playToast: c2 } = N(n2), { closeButton: d2, children: p2, autoClose: m2, onClick: f2, type: g2, hideProgressBar: y2, closeToast: v2, transition: h2, position: T2, className: E2, style: b2, bodyClassName: I2, bodyStyle: _2, progressClassName: C2, progressStyle: L2, updateId: k2, role: P2, progress: w2, rtl: M2, toastId: x2, deleteToast: A2, isIn: B2, isLoading: O2, closeOnClick: z2, theme: R2 } = n2, S2 = clsx_default("Toastify__toast", `Toastify__toast-theme--${R2}`, `Toastify__toast--${g2}`, { "Toastify__toast--rtl": M2 }, { "Toastify__toast--close-on-click": z2 }), H2 = u(E2) ? E2({ rtl: M2, position: T2, type: g2, defaultClassName: S2 }) : clsx_default(S2, E2), F2 = function(e2) {
    let { theme: n3, type: o3, isLoading: s3, icon: r4 } = e2, i3 = null;
    const l = { theme: n3, type: o3, isLoading: s3 };
    return false === r4 || (u(r4) ? i3 = r4(l) : (0, import_react.isValidElement)(r4) ? i3 = (0, import_react.cloneElement)(r4, l) : s3 ? i3 = D.spinner() : ((e3) => e3 in D)(o3) && (i3 = D[o3](l))), i3;
  }(n2), X2 = !!w2 || !m2, Y2 = { closeToast: v2, type: g2, theme: R2 };
  let q2 = null;
...
var S = g(R("bounce", true));
var H = g(R("slide", true));
var F = g(R("zoom"));
var X = g(R("flip"));
var Y = { position: "top-right", transition: S, autoClose: 5e3, closeButton: true, pauseOnHover: true, pauseOnFocusLoss: true, draggable: "touch", draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
function q(t2) {
  let s2 = { ...Y, ...t2 };
  const a2 = t2.stacked, [r3, c2] = (0, import_react.useState)(true), d2 = (0, import_react.useRef)(null), { getToastToRender: m2, isToastActive: f2, count: g2 } = L(s2), { className: y2, style: v2, rtl: h2, containerId: T2 } = s2;
  function E2(e2) {
    const t3 = clsx_default("Toastify__toast-container", `Toastify__toast-container--${e2}`, { "Toastify__toast-container--rtl": h2 });
    return u(y2) ? y2({ position: e2, rtl: h2, defaultClassName: t3 }) : clsx_default(t3, p(y2));
  }
  function b2() {
    a2 && (c2(true), B.play());
  }
  return (0, import_react.useLayoutEffect)(() => {
    if (a2) {
      var e2;
      const t3 = d2.current.querySelectorAll('[data-in="true"]'), n2 = 12, o2 = null == (e2 = s2.position) ? void 0 : e2.includes("top");
      let a3 = 0, i2 = 0;
      Array.from(t3).reverse().forEach((e3, t4) => {
        const s3 = e3;
        s3.classList.add("Toastify__toast--stacked"), t4 > 0 && (s3.dataset.collapsed = `${r3}`), s3.dataset.pos || (s3.dataset.pos = o2 ? "top" : "bot");
        const l = a3 * (r3 ? 0.2 : 1) + (r3 ? 0 : n2 * t4);
        s3.style.setProperty("--y", `${o2 ? l : -1 * l}px`), s3.style.setProperty("--g", `${n2}`), s3.style.setProperty("--s", "" + (1 - (r3 ? i2 : 0))), a3 += s3.offsetHeight, i2 += 0.025;
      });
    }
  }, [r3, g2, a2]), import_react.default.createElement("div", { ref: d2, className: "Toastify", id: T2, onMouseEnter: () => {
    a2 && (c2(false), B.pause());
  }, onMouseLeave: b2 }, m2((t3, n2) => {
    const o2 = n2.length ? { ...v2 } : { ...v2, pointerEvents: "none" };
    return import_react.default.createElement("div", { className: E2(t3), style: o2, key: `container-${t3}` }, n2.map((t4) => {
      let { content: n3, props: o3 } = t4;
      return import_react.default.createElement(z, { ...o3, stacked: a2, collapseAll: b2, isIn: f2(o3.toastId, o3.containerId), style: o3.style, key: `toast-${o3.key}` }, n3);
    }));
  }));
}
export {
