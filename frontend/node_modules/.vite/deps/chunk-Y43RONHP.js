...
var FormCheckLabel = React.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React3.forwardRef(({
  ...
  const input = (0, import_jsx_runtime2.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime2.jsx)(FormContext_default.Provider, {
    value: innerFormContext,
    children: (0, import_jsx_runtime2.jsx)("div", {
      style,
      className: (0, import_classnames2.default)(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === "switch" && bsSwitchPrefix),
      children: children || (0, import_jsx_runtime4.jsxs)(import_jsx_runtime3.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime2.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime2.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormFloating = React4.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var FormGroup = React5.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = "div",
  ...props
...
var FormLabel = React6.forwardRef(({
  ...
  const classes = (0, import_classnames4.default)(className, bsPrefix, visuallyHidden && "visually-hidden", column && columnClass);
  true ? (0, import_warning.default)(controlId == null || !htmlFor, "`controlId` is ignored on `<FormLabel>` when `htmlFor` is specified.") : void 0;
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime7.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
...
var FormSelect = React8.forwardRef(({
  ...
  return (0, import_jsx_runtime9.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
    className: (0, import_classnames6.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var FormText = React9.forwardRef(
  ...
  ({
    ...
    return (0, import_jsx_runtime10.jsx)(Component, {
      ...props,
      ref,
      className: (0, import_classnames7.default)(className, bsPrefix, muted && "text-muted")
    });
  }
);
...
var Switch = React10.forwardRef((props, ref) => (0, import_jsx_runtime11.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React11.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
  ...
  bsPrefix = useBootstrapPrefix(bsPrefix, "form-floating");
  return (0, import_jsx_runtime13.jsxs)(FormGroup_default, {
    ref,
...
var Form = React12.forwardRef(({
  ...
  ...props,
  ref,
  className: (0, import_classnames9.default)(className, validated && "was-validated")
}));
...
//# sourceMappingURL=chunk-Y43RONHP.js.map
